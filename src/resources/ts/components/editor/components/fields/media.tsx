            ...
            {hasMedia && showAltSelect && !loading && (
                <div className="form-group margin-block-start-4">
                    <label htmlFor={`${id}-alt`}>
                        {translate('content-manager.admin.editor.sidebar.tabs.media.alt')}
                    </label>
                    <select
                        id={`${id}-alt`}
                    ...
                    >
                        <option value="">
                            {alts.find(a => a.isDefault)?.text || translate('content-manager.admin.editor.sidebar.tabs.media.alt.default')}
                        </option>
                        {alts
