    ...
    return (
        <Tooltip
            content={
                success ? (
                    <>
                        {translate('content-manager.admin.editor.sidebar.action.copy.success')}
                        <br/>
                        {translate('content-manager.admin.editor.sidebar.action.copy.instructions')}
                    </>
                ) : Array.isArray(data) ? translate('content-manager.admin.editor.sidebar.action.copy.page') : translate('content-manager.admin.editor.sidebar.action.copy.component')
            }
            trigger='mouseenter'
        >
            <button
