...
import Icon from "@core-cms-shared/components/Icon";
        ...
        <div className='sidebar' {...props}>
            <div className='sidebar__header'>
                <button
                    ...
                    title={translate('content-manager.admin.editor.sidebar.close')}
                >
                ...
                <div className='flex-group align-items-center'>
                    ...
                    <button
                        ...
                        title={translate('content-manager.admin.editor.sidebar.mode.responsive')}
                    >
                    ...
                    >
                        ...
                        {translate('content-manager.admin.editor.sidebar.component.add')}
                    </button>
                </div>
            </div>
            {state === States.BLOCS &&
