...
@section('title')
    @if($category->exists)
    {{ __('core-cms::admin.edit') }} {{ trans_choice('content-manager::admin.content.category.value', 1) }}
    @else
        {{ __('core-cms::admin.create') }} {{ trans_choice('content-manager::admin.content.category.value', 1) }}
    @endif
@endsection
