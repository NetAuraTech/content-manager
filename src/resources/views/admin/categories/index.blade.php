...
@section('title')
    {{ __('core-cms::admin.manage') }} {{ trans_choice('content-manager::admin.content.category.value', 2) }}
@endsection
    ...
    <section class="grid">
        <div class="flex-group justify-content-space-between align-items-center" style="width: initial">
            ...
            <a class="button" href="{{ route('admin.categories.create') }}" data-type="primary">
                {{ __('core-cms::admin.add') }} {{ trans_choice('content-manager::admin.content.category.value', 1) }}
            </a>
        </div>
        <div class="card">
            <table class="table">
                ...
                <tr>
                    <th>ID</th>
                    <th>{{ __('content-manager::admin.content.name') }}</th>
